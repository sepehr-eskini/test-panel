...
<div class="nav">
	...
	<ul>
		<li class="<?php if($fileName == 'panel_profile.php' || $fileName == 'panel_profileEdit.php' || $fileName == 'panel_changePassword.php') {echo 'active';} ?>"><a href="panel_profile.php">Profile</a></li>
